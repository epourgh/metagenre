...
export default function Medium() {
    ...
    const [similar, setSimilar] = useState({title: undefined, mediums: [[{id: 1, title: '', percentage: 0}], [{id: 2, title: '', percentage: 0}], [{id: 3, title: '', percentage: 0}]]});
    ...
    useEffect(() => {
        ...
        setSimilar((typeof reducers.medium.similar !== 'undefined')?reducers.medium.similar:{title: undefined, mediums: [[{id: 1, title: '', percentage: 0}], [{id: 2, title: '', percentage: 0}], [{id: 3, title: '', percentage: 0}]]});
    ...
    const RenderSimilar = () => {
        ...
        if (typeof similar.title !== "undefined") {
            return (
                <>
                    <br/><hr/><br/>
                    <div>
