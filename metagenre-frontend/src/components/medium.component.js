...
export default function Medium() {
    ...
    const getMediumsDetails = () => {
        fetch(`http://18.225.9.206:4000/mediumsDetails/${id}`)
    ...
    const getPlatforms = () => {
        fetch(`http://18.225.9.206:4000/platforms`)
            .then(response => response.json())
            .then(response => {
    ...
    const getRegions = () => {
    fetch(`http://18.225.9.206:4000/regions`)
        .then(response => response.json())
        .then(response => {
    ...
    const getSimilarMediums = () => {
        fetch(`http://18.225.9.206:4000/similar/${id}`)
            .then(response => response.json())
            .then(response => {
                console.log(response.data);
    ...
    const getExternalLinks = () => {
        fetch(`http://18.225.9.206:4000/mediumExternalLinks/${id}`)
            .then(response => response.json())
            .then(response => {
                console.log('response.data')
                console.log(response.data);
    ...
    const getCreatorsSeries = () => {
        fetch(`http://18.225.9.206:4000/mediumsCreatorsSeries/view/${id}`)
            .then(response => response.json())
            .then(response => {
    ...
    const getMediumsGenresMultiple = (mediumsGenres, userBooleanMediumsGenres) => {
        ...
        fetch(`http://18.225.9.206:4000/${userBooleanMediumsGenres}?userId=${loggedIn.id}&mediumId=${id}`)
            .then(response => response.json())
            .then(response => {
                console.log(response.data)
                if (response.data !== undefined) {
        ...
        fetch(`http://18.225.9.206:4000/${mediumsGenres}/view/${id}`)
            .then(response => response.json())
            .then(response => {
    ...
    const getMediumsGenres = (stringParam) => {
        ...
        fetch(`http://18.225.9.206:4000/${stringParam}/view/${id}`)
            .then(response => response.json())
            .then(response => {
                console.log(response.data.length)
                if (response.data.length > 0) {
    ...
    const voteMediumGenre = (mediumGenresId, routeString, routeString2, mediumGenreVotes, genreId, symbol) => {
        ...
        fetch(`http://18.225.9.206:4000/${routeString}/update/${mediumGenresId}?votes=${mediumGenreVotes}&symbol=${symbol.toString()}&userId=${loggedIn.id}&mediumId=${id}&genreId=${genreId}`)
            .then(response => {
    ...
    const addGenreToMedium = () => {
        ...
        if (typeof medium.genreName != undefined 
            ...
            fetch(`http://18.225.9.206:4000/mediumsGenresChecker?genreName=${medium.genreName}&userId=${loggedIn.id}&mediumId=${id}&mediumType=${medium.genreType}`)
                .then(update => {
